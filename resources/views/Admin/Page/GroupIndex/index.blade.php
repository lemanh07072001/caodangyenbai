...
{{--  Title  --}}
@section('title','Danh sách nhóm tin tức')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-2 ">
                    <a href="{{route('groupPost.create')}}" class="btn btn-success btn-block btn-sm">Thêm dữ liệu</a>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        const url = '{!! route('groupPost.getData') !!}';
